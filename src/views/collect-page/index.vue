<template>
    <div>
        <el-card>
            <div class="searchDiv">
                <el-input v-model="userId" placeholder="收藏用户ID" class="width1"></el-input>
            ...
            <el-table :data="tableData" :header-cell-style="{ background: '#eaf6f6', color: '#13b5b1' }" border style="box-shadow:0 0 10px #e2e2e2">
                <el-table-column prop="collectId" align="center" label="收藏ID"></el-table-column>
                <el-table-column prop="userId" align="center" label="收藏用户ID"></el-table-column>
                <el-table-column prop="userNickName" align="center" label="收藏用户昵称" width="200px">
                    <template slot-scope="scope">
                        <link-a url='/userinfo/index' :userId='scope.row.userId' :val='scope.row.userNickName' />
                    </template>
                </el-table-column>
                <el-table-column prop="createDateTime" align="center" label="收藏时间" width="200px"></el-table-column>
...
import { GetProductCollectList } from "@/api/collect";
...
export default {
  ...
  mounted() {
    this._GetProductCollectList();
  },
  components: {
    LinkA,
  },
  methods: {
    _GetProductCollectList() {
      let data = {
      ...
      GetProductCollectList(data).then(res => {
